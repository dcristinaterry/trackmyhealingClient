        ...
        <nav className="bg-gray-800">
            <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                <div className="relative flex items-center justify-between h-16">
                    ...
                    <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                        <div className="flex-shrink-0">
                            {/* temp logo CHANGE AFTER getting our own */}
                            <img className="block lg:block h-8 w-auto " src="https://tailwindui.com/img/logos/workflow-mark-on-dark.svg" alt="logo" />
                            {/* <img className="hidden md:block h-8 w-auto" src="https://tailwindui.com/img/logos/workflow-logo-on-dark.svg" alt="Workflow logo" /> */}

                        </div>
                        <div>
                            <h1 className="ml-6 text-white my-auto">Track my Healing</h1>
                        </div>
                        <div className="hidden sm:block sm:ml-6">
                            <div className="flex">
                                ...
                                <a href="#" className="ml-4 px-3 py-2 rounded-md text-sm font-medium leading-5 text-white bg-gray-900 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">Notifications</a>
                            </div>
                        </div>
                    </div>
                    <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        ...
                        <div className="ml-3 relative">
                            <div>
                                <button classNameName="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:bg-gray-700 focus:text-white transition duration-150 ease-in-out"
                ...
                // --> */}
                      ...
                      { getShowMenu &&    ( < div className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg" >
            ...
            <div className="hidden sm:hidden">
                <div className="px-2 pt-2 pb-3">
                    ...
                    <a href="#" className="mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">Notifications</a>
                </div>
            </div>
